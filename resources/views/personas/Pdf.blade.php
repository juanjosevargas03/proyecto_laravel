        ...
        <!-- PAGE CONTAINER-->
                <div class="section__content section__content--p30">
                    ...
                    <div class="container-fluid">
                        ...
                        <div class="row">
                            <div class="col-lg-12">
                                <h2 class="title-1 m-b-25">Aspirante  {{ $persona->Nombre}}</h2>
                                    ...
                                    <table class="table  table-striped table-earning" border="1">
                                        ...
                                        <tbody>
                                            ...
                                            <tr>
                                                ...
                                                <td width="350px">{{$persona->Nombre}}</td>
                                            </tr>
                                            <tr>
                                            ...
                                            <tr>
                                                ...
                                                <td>{{$persona->F_icfes}}</td>
                                            </tr>
                                            <tr>
                                                <th>Puntaje icfes</th>

                                                <td>{{$persona->Puntaje_icfes}}</td>
                                            </tr>
                                           <tr>
                                                <th>Nombre de la madre</th>

                                                <td>{{$persona->N_madre}}</td>
                                            </tr>
                                            <tr>
                                                <th>Ocupacion de la madre</th>

                                                <td>{{$persona->Ocup_madre}}</td>
                                            </tr>
                                             <tr>
                                                <th>Nombre del padre</th>

                                                <td>{{$persona->N_padre}}</td>
                                            </tr>
                                             
                                             <tr>
                                                <th>Ocupacion del padre</th>

                                                <td>{{$persona->Ocup_padre}}</td>
                                            </tr>
                                            <tr>
                                                <th>Nombre de hermano/a</th>

                                                <td>{{$persona->N_hermano}}</td>
                                            </tr>
                                            <tr>
                                                <th>Ocupacion de hermano/a</th>

                                                <td>{{$persona->Ocup_hermano}}</td>
                                            </tr>
                                             <tr>
                                                <th>Institucion donde curso el Bachillerato</th>

                                                <td>{{$persona->Bachillerato}}</td>
                                            </tr>
                                             <tr>
                                                <th>Año de grado</th>

                                                <td>{{$persona->Año_grado}}</td>
                                            </tr>
                                             <tr>
                                                <th>Estudios adicionales</th>

                                                <td>{{$persona->Estudios_adicionales}}</td>
                                            </tr>
                                             <tr>
                                                <th>Idiomas</th>
                                                <td>
