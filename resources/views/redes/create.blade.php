                            ...
                            <div class="col-lg-10">
                                <div class="card">
                                    <div class="card-header">
                                        <strong class="">Guardar </strong>
                                    </div>
                                    <div class="card-body card-block">

	<form class="form-horizontal" method="POST" action="{{ route('redes.store') }}">
        ...
        <div class="row form-group">
                                                ...
                                                <div class="col-12 col-md-4">
                                                    <input type="date" id="fecha_vinculacion" name="fecha_vinculacion" placeholder="" class="form-control" value="{{old('fecha_vinculacion',$red->fecha_vinculacion)}}">
        ...
        <div class="row form-group">
                                                ...
                                                <div class="col-12 col-md-7">
                                                    ...
                                                    <textarea id="actividad_realizada" name="actividad_realizada" placeholder="" class="form-control" value="{{old('actividad_realizada',$red->actividad_realizada)}}" rows="3"></textarea>
         ...
         <div class="row form-group">
                                                ...
                                                <div class="col-12 col-md-4">
                                                    <input type="date" id="fecha_actividad" name="fecha_actividad" placeholder="" class="form-control" value="{{old('fecha_actividad',$red->fecha_actividad)}}">
        ...
        <div class="row form-group">
                                                ...
                                                <div class="col-12 col-md-7">
                                                    <textarea rows="3" name="impacto_actividad" placeholder="" class="form-control" value="{{old('impacto_actividad',$red->impacto_actividad)}}">
                                                    </textarea>
        ...
        <div class="row form-group">
         ...
         <div class="row form-group">
                                                ...
                                                <div class="col-12 col-md-7">
                                                    <textarea rows="3" id="observaciones" name="observaciones" placeholder="" class="form-control" value="{{old('observaciones',$red->observaciones)}}"></textarea>
