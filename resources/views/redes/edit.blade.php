...
<body class="animsition">
	...
	<form class="form-horizontal" method="POST" action="{{ route('update_redes') }}">
		 @method('PATCH')
...
@csrf
		...
		<div class="row form-group">
                                                ...
                                                <div class="col-12 col-md-7">
                                                    <input type="text" id="unidad" name="unidad" placeholder="" class="form-control" value="{{old('unidad',$red->unidad)}}">
         ...
         <div class="row form-group">
                                                ...
                                                <div class="col-12 col-md-7">
                                                    <select name="programa" id="programa" class="form-control">
                                                        <option value="{{old('programa',$red->programa)}}">{{old('programa',$red->programa)}}</option>
        ...
        <div class="row form-group">
                                                ...
                                                <div class="col-12 col-md-7">
                                                    <input type="text" id="asociacion" name="asociacion" placeholder="" class="form-control" value="{{old('asociacion',$red->asociacion)}}">
        ...
        <div class="row form-group">
                                                ...
                                                <div class="col-12 col-md-7">
                                                    <select name="ubicacion" id="ubicacion" class="form-control"> 
                                                        <option value="{{old('ubicacion',$red->ubicacion)}}">{{old('ubicacion',$red->ubicacion)}}</option>
        ...
        <div class="row form-group">
                                                ...
                                                <div class="col-12 col-md-7">
                                                    <select name="objeto" id="objeto" class="form-control"> 
                                                        <option value="{{old('objeto',$red->objeto)}}">{{old('objeto',$red->objeto)}}</option>
        ...
        <div class="row form-group">
                                                ...
                                                <div class="col-12 col-md-7">
                                                    <input type="number" id="costo_membresia" name="costo_membresia" placeholder="" class="form-control" value="{{old('costo_membresia',$red->costo_membresia)}}">
        ...
        <div class="row form-group">
                                                ...
                                                <div class="col-12 col-md-7">
                                                    <input type="text" id="periodicidad_pago" name="periodicidad_pago" placeholder="" class="form-control" value="{{old('periodicidad_pago',$red->periodicidad_pago)}}">
        ...
        <div class="row form-group">
                                                ...
                                                <div class="col-12 col-md-4">
                                                    <input type="text" id="fecha_vinculacion" name="fecha_vinculacion" placeholder="" class="form-control" value="{{old('fecha_vinculacion',$red->fecha_vinculacion)}}">
		...
		<div class="row form-group">
                                                ...
                                                <div class="col-12 col-md-7">
                                                    <select name="estado_vinculacion" id="estado_vinculacion" class="form-control"> 
                                                        <option value="{{old('estado_vinculacion',$red->estado_vinculacion)}}">{{old('estado_vinculacion',$red->estado_vinculacion)}}</option>
        ...
        <div class="row form-group">
                                                ...
                                                <div class="col-12 col-md-7">
                                                    ...
                                                    <textarea id="actividad_realizada" name="actividad_realizada" placeholder="" class="form-control" value="{{old('actividad_realizada',$red->actividad_realizada)}}" rows="3">{{old('actividad_realizada',$red->actividad_realizada)}}</textarea>
         ...
         <div class="row form-group">
                                                ...
                                                <div class="col-12 col-md-4">
                                                    <input type="text" id="fecha_actividad" name="fecha_actividad" placeholder="" class="form-control" value="{{old('fecha_actividad',$red->fecha_actividad)}}">
        ...
        <div class="row form-group">
                                                ...
                                                <div class="col-12 col-md-7">
                                                    <input type="number" id="num_participantes" name="num_participantes" placeholder="" class="form-control" value="{{old('num_participantes',$red->num_participantes)}}">
        ...
        <div class="row form-group">
                                                ...
                                                <div class="col-12 col-md-7">
                                                    <textarea rows="3" name="impacto_actividad" placeholder="" class="form-control" value="{{old('impacto_actividad',$red->impacto_actividad)}}">{{old('impacto_actividad',$red->impacto_actividad)}}
                                                    </textarea>
        ...
        <div class="row form-group">
                                                ...
                                                <div class="col-12 col-md-7">
                                                    <input type="text" id="responsable_unisinu" name="responsable_unisinu" placeholder="" class="form-control" value="{{old('responsable_unisinu',$red->responsable_unisinu)}}">
        ...
        <div class="row form-group">
                                                ...
                                                <div class="col-12 col-md-7">
                                                    <input type="text" id="pagina_web" name="pagina_web" placeholder="" class="form-control" value="{{old('pagina_web',$red->pagina_web)}}">
         ...
         <div class="row form-group">
                                                ...
                                                <div class="col-12 col-md-7">
                                                    <textarea rows="3" id="observaciones" name="observaciones" placeholder="" class="form-control" value="{{old('observaciones',$red->observaciones)}}">{{old('observaciones',$red->observaciones)}}</textarea>
