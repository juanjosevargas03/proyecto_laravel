                            ...
                            <div class="col-lg-10">
                                <div class="card">
                                    <div class="card-header">
                                        <strong class="">Editar la informacion de <?php echo e($persona->Nombre); ?> </strong>
                                    </div>
                                    <div class="card-body card-block">
                                        <form action="<?php echo e(url('/personas/'.$persona->id)); ?>" method="post" class="form-horizontal">
                                            ...
                                            <div class="row form-group">
                                                ...
                                                <div class="col-12 col-md-7">
                                                    <input type="text" id="Nombre" name="Nombre" value="<?php echo e($persona->Nombre); ?>" class="form-control">
                                             ...
                                             <div class="row form-group">
                                                ...
                                                <div class="col-12 col-md-7">
                                                    <select name="Tipo_id" id="Tipo_id" class="form-control" >
                                                        <option value="<?php echo e($persona->Tipo_id); ?>"><?php echo e($persona->Tipo_id); ?></option>
                                                ...
                                                <div class="col-12 col-md-7">
                                                    <input type="text" id="Identificacion" name="Identificacion" value="<?php echo e($persona->Identificacion); ?>" class="form-control">
                                            ...
                                            <div class="row form-group">
                                                ...
                                                <div class="col-12 col-md-7">
                                                    <select name="Programa" id="Programa" class="form-control">
                                                        <option value="<?php echo e($persona->Programa); ?>"><?php echo e($persona->Programa); ?></option>
                                             ...
                                             <div class="row form-group">
                                                ...
                                                <div class="col-12 col-md-7">
                                                    <input type="text" id="Año" name="Año" value="<?php echo e($persona->Año); ?>" class="form-control">
                                            ...
                                            <div class="row form-group">
                                                ...
                                                <div class="col-12 col-md-4">
                                                    <input type="text" id="F_nacimiento" name="F_nacimiento" value="<?php echo e($persona->F_nacimiento); ?>" class="form-control">
                                                </div>
                                            </div>
                                                ...
                                                <div class="col-12 col-md-7">
                                                    <input type="text" id="Ciudad" name="Ciudad" value="<?php echo e($persona->Ciudad); ?>" class="form-control">
                                                </div>
                                            </div>
                                            ...
                                            <div class="row form-group">
                                                ...
                                                <div class="col-12 col-md-7">
                                                    <input type="text" id="Direccion" name="Direccion" value="<?php echo e($persona->Direccion); ?>" class="form-control">
                                                </div>
                                            </div>
                                            ...
                                            <div class="row form-group">
                                                ...
                                                <div class="col-12 col-md-7">
                                                    <input type="text" id="Telefono" name="Telefono" value="<?php echo e($persona->Telefono); ?>" class="form-control">
                                                </div>
                                            </div>
                                             ...
                                             <div class="row form-group">
                                                ...
                                                <div class="col-12 col-md-4">
                                                    <input type="text" id="F_icfes" name="F_icfes" value="<?php echo e($persona->F_icfes); ?>" class="form-control">
                                                </div>
                                            </div>
                                            ...
                                            <div class="row form-group">
                                                ...
                                                <div class="col-12 col-md-7">
                                                    <input type="text" id="Puntaje_icfes" name="Puntaje_icfes" value="<?php echo e($persona->Puntaje_icfes); ?>" class="form-control">
                                                </div>
                                            </div>
                                            ...
                                            <div class="row form-group">
                                                ...
                                                <div class="col-12 col-md-7">
                                                    <input type="text" id="N_madre" name="N_madre" value="<?php echo e(@$persona->N_madre); ?>" class="form-control">
                                                </div>
                                            </div>
                                            <div class="row form-group">
                                                <div class="col col-md-3">
                                                ...
                                                <div class="col-12 col-md-7">
                                                    <input type="text" id="Ocup_madre" name="Ocup_madre" value="<?php echo e($persona->Ocup_madre); ?>" class="form-control">
                                                </div>
                                            </div>
                                            <div class="row form-group">
                                                <div class="col col-md-3">
                                                ...
                                                <div class="col-12 col-md-7">
                                                    <input type="text" id="N_padre" name="N_padre" value="<?php echo e($persona->N_padre); ?>" class="form-control">
                                                </div>
                                            </div>
                                            ...
                                            <div class="row form-group">
                                                ...
                                                <div class="col-12 col-md-7">
                                                    <input type="text" id="Ocup_padre" name="Ocup_padre" value="<?php echo e($persona->Ocup_padre); ?>" class="form-control">
                                                </div>
                                            </div>
                                            <div class="row form-group">
                                                <div class="col col-md-3">
                                                ...
                                                <div class="col-12 col-md-7">
                                                    <input type="text" id="N_hermano" name="N_hermano" value="<?php echo e(@$persona->N_hermano); ?>" class="form-control"> 
                                                </div>
                                            </div>
                                            <div class="row form-group">
                                                <div class="col col-md-3">
                                                ...
                                                <div class="col-12 col-md-7">
                                                    <input type="text" id="Ocup_hermano" name="Ocup_hermano" value="<?php echo e(@$persona->Ocup_hermano); ?>" class="form-control"> 
                                                </div>
                                             </div>
                                             <div class="row form-group">
                                                <div class="col col-md-3">
                                                ...
                                                <div class="col-12 col-md-7">
                                                    <input type="text" id="Bachillerato" name="Bachillerato" value="<?php echo e($persona->Bachillerato); ?>" class="form-control">
                                                </div>
                                            </div>
                                             <div class="row form-group">
                                                <div class="col col-md-3">
                                                ...
                                                <div class="col-12 col-md-7">
                                                    <input type="text" id="Año_grado" name="Año_grado" value="<?php echo e($persona->Año_grado); ?>" class="form-control">
                                                </div>
                                            </div>
                                             <div class="row form-group">
                                                <div class="col col-md-3">
                                                ...
                                                <div class="col-12 col-md-7">
                                                    <input type="text" id="Estudios_adicionales" name="Estudios_adicionales" value="<?php echo e($persona->Estudios_adicionales); ?>" class="form-control">
                                                </div>
                                            </div>
                                             ...
                                             <div class="row form-group">
                                                ...
                                                <div class="col-12 col-md-7">
                                                    <select name="idiomas[]" id="idiomas" class="form-control" multiple>
                                                        ...
                                                        <option selected value="<?php echo e($i->Nombre); ?>"><?php echo e($i->Nombre); ?></option>
                                            ...
                                            <div class="row form-group">
                                                ...
                                                <div class="col-12 col-md-7">
                                                    <select name="Opciones_carrera" id="Opciones_carrera" class="form-control" >
                                                        ...
                                                        <option value="<?php echo e($persona->Opciones_carrera); ?>"><?php echo e($persona->Opciones_carrera); ?></option>
                                                        <option value="Gestion y Liderazgo">Gestion y Liderazgo</option>
                                                        <option value="Medicina">Medicina</option>
                                                        <option value="Nutricion y dietetica">Nutricion y dietetica</option>
                                                        <option value="Preventiva y Comunitaria">Preventiva y Comunitaria</option>
                                             ...
                                             <div class="row form-group">
                                                ...
                                                <div class="col-12 col-md-7">
                                                    <input type="text" id="Puntaje" name="Puntaje" value="<?php echo e($persona->Puntaje); ?>" class="form-control">
                                                </div>
                                            </div>
...
<br>
    ...
    return false;
                                            ...
                                            <button class="btn btn-danger btn-lg btn-block" type="submit">Modificar</button>
                                             ...
                                             <form method="post" action="<?php echo e(route('pdf_persona')); ?>" >
                                            <?php echo csrf_field(); ?>
                                            <input type="number" hidden value="<?php echo e($persona->id); ?>" name="id">
...
<?php /**PATH C:\laragon\www\proyecto\resources\views/edit.blade.php ENDPATH**/ ?>