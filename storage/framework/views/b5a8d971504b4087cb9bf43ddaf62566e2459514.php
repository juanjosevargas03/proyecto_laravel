<body class="animsition">
	...
	<form class="form-horizontal" method="POST" action="<?php echo e(route('curriculos.store')); ?>">
        ...
        <div class="row form-group">
                                                ...
                                                <div class="col-12 col-md-7">
                                                    <textarea rows="3" name="descripcion" placeholder="" class="form-control" >
                                                    </textarea>
...
<?php echo $__env->make('panel', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\laragon\www\proyecto\resources\views/curriculos/create.blade.php ENDPATH**/ ?>