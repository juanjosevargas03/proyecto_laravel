<body class="animsition">
	...
	<form class="form-horizontal" method="POST" action="<?php echo e(route('redes.store')); ?>">
        ...
        <div class="row form-group">
                                                ...
                                                <div class="col-12 col-md-4">
                                                    <input type="date" id="fecha_vinculacion" name="fecha_vinculacion" placeholder="" class="form-control" value="<?php echo e(old('fecha_vinculacion',$red->fecha_vinculacion)); ?>">
        ...
        <div class="row form-group">
                                                ...
                                                <div class="col-12 col-md-7">
                                                    ...
                                                    <textarea id="actividad_realizada" name="actividad_realizada" placeholder="" class="form-control" value="<?php echo e(old('actividad_realizada',$red->actividad_realizada)); ?>" rows="3"></textarea>
         ...
         <div class="row form-group">
                                                ...
                                                <div class="col-12 col-md-4">
                                                    <input type="date" id="fecha_actividad" name="fecha_actividad" placeholder="" class="form-control" value="<?php echo e(old('fecha_actividad',$red->fecha_actividad)); ?>">
        ...
        <div class="row form-group">
                                                ...
                                                <div class="col-12 col-md-7">
                                                    <textarea rows="3" name="impacto_actividad" placeholder="" class="form-control" value="<?php echo e(old('impacto_actividad',$red->impacto_actividad)); ?>">
                                                    </textarea>
        ...
        <div class="row form-group">
         ...
         <div class="row form-group">
                                                ...
                                                <div class="col-12 col-md-7">
                                                    <textarea rows="3" id="observaciones" name="observaciones" placeholder="" class="form-control" value="<?php echo e(old('observaciones',$red->observaciones)); ?>"></textarea>
...
<?php echo $__env->make('panel', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\laragon\www\proyecto\resources\views/redes/create.blade.php ENDPATH**/ ?>