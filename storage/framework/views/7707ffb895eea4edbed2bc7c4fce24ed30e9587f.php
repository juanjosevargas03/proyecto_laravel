<body class="animsition">
	...
	<form class="form-horizontal" method="POST" action="<?php echo e(route('update_curriculos')); ?>">
...
<?php echo csrf_field(); ?>
          ...
          <div class="row form-group">
                                                ...
                                                <div class="col-12 col-md-7">
                                                    <select name="seccional" id="seccional" class="form-control"> 
                                                        <option value="<?php echo e(old('seccional',$curriculo->seccional)); ?>"><?php echo e(old('seccional',$curriculo->seccional)); ?></option>
        ...
        <div class="row form-group">
                                                ...
                                                <div class="col-12 col-md-7">
                                                    <select name="area_conocimiento" id="area_conocimiento" class="form-control"> 
                                                        <option value="<?php echo e(old('area_conocimiento',$curriculo->area_conocimiento)); ?>"><?php echo e(old('area_conocimiento',$curriculo->area_conocimiento)); ?></option>
         ...
         <div class="row form-group">
                                                ...
                                                <div class="col-12 col-md-7">
                                                    <select name="facultad" id="facultad" class="form-control">
                                                        <option value="<?php echo e(old('facultad',$curriculo->facultad)); ?>"><?php echo e(old('facultad',$curriculo->facultad)); ?></option>
        ...
        <div class="row form-group">
                                                ...
                                                <div class="col-12 col-md-7">
                                                    <select name="componente" id="componente" class="form-control"> 
                                                        <option value="<?php echo e(old('componente',$curriculo->componente)); ?>"><?php echo e(old('componente',$curriculo->componente)); ?></option>
        ...
        <div class="row form-group">
                                                ...
                                                <div class="col-12 col-md-7">
                                                    <textarea rows="3" name="descripcion" placeholder="" class="form-control" value="<?php echo e(old('descripcion',$curriculo->descripcion)); ?>" ><?php echo e(old('descripcion',$curriculo->descripcion)); ?>
         ...
         <div class="row form-group">
                                                ...
                                                <div class="col-12 col-md-7">
                                                    <select name="mes" id="mes" class="form-control"> 
                                                        <option value="<?php echo e(old('mes',$curriculo->mes)); ?>"><?php echo e(old('mes',$curriculo->mes)); ?></option>
        ...
        <div class="row form-group">
                                                ...
                                                <div class="col-12 col-md-7">
                                                    <input type="text" id="año" name="año" placeholder="" class="form-control" value="<?php echo e(old('año',$curriculo->año)); ?>">
        ...
        <div class="row form-group">
                                                ...
                                                <div class="col-12 col-md-7">
                                                    <input type="text" id="responsable" name="responsable" placeholder="" class="form-control" value="<?php echo e(old('responsable',$curriculo->responsable)); ?>">
         ...
         <div class="row form-group">
                                                ...
                                                <div class="col-12 col-md-7">
                                                    <input type="email" id="correo" name="correo" placeholder="" class="form-control" value="<?php echo e(old('correo',$curriculo->correo)); ?>">
         ...
         <div class="row form-group">
                                                ...
                                                <div class="col-12 col-md-7">
                                                    <input type="text" id="contacto" name="contacto" placeholder="" class="form-control" value="<?php echo e(old('contacto',$curriculo->contacto)); ?>">
...
<?php echo $__env->make('panel', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\laragon\www\proyecto\resources\views/curriculos/edit.blade.php ENDPATH**/ ?>